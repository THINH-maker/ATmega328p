...
void LCD_Str_Cursor(unsigned char row, unsigned char column, char *s);
void LCD_Char(unsigned char chr);
void LCD_Char_Cursor(unsigned char row,unsigned char column,unsigned char chr);
void LCD_Init();
void LCD_Enable();
